...
namespace Paylocity.Employees.DataContext
{
     ...
     */
    public sealed class EmployeesDataContext
    {
        private static readonly Lazy<EmployeesDataContext> lazy = new Lazy<EmployeesDataContext>(() => new EmployeesDataContext());
        ...
        public static EmployeesDataContext Instance => lazy.Value;

        private EmployeesDataContext()
        {
